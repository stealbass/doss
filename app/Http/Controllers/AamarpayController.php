...
class AamarpayController extends Controller
{
    ...
    public function planPayWithpay(Request $request)
    {
        ...
        if ($plan) {
            ...
            try {
                ...
                if ($aamarpay_mode == 'sandbox') {
                    $url1 = 'https://sandbox.aamarpay.com/' . $url_forward;
                } else {
                    $url1 = 'https://secure.aamarpay.com/' . $url_forward;
                }
                $this->redirect_to_merchant($url1);
    ...
    function redirect_to_merchant($url1)
    {
        ...
        <body onLoad="closethisasap();">
            ...
            <form name="redirectpost" method="post" action="<?php echo $url1; ?>">
    ...
    public function invoicePayWithaamarpay(Request $request)
    {
        ...
        if ($invoice && $get_amount != 0) {
            ...
            try {
                ...
                if ($aamarpay_mode == 'sandbox') {
                    $url2 = 'https://sandbox.aamarpay.com/' . $url_forward;
                } else {
                    $url2 = 'https://secure.aamarpay.com/' . $url_forward;
                }
                $this->redirect_to_merchant($url2);
            } catch (\Exception $e) {
