    ...
    public function index(Request $request)
{
    ...
    public function create()
    {
        if (Auth::user()->can('create case')) {
            ...
            // Allow assigning any non-client user (advocates, employés, admins)
            $assignables = User::where('created_by', Auth::user()->creatorId())
                ->where('type', '!=', 'client')
                ->pluck('name', 'id');
            ...
            return view('cases.create', compact('courts', 'assignables', 'clients', 'case_typ'));
        } else {
            return redirect()->back()->with('error', __('Permission Denied.'));
        }
    }
    ...
    public function edit($id)
    {
        if (Auth::user()->can('edit case')) {
            ...
            return view('cases.edit', compact('courts', 'assignables', 'clients', 'case_typ', 'case', 'your_advocates', 'documents'));
        } else {
            return redirect()->back()->with('error', __('Permission Denied.'));
        }
    }
