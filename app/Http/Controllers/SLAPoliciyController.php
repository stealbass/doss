        ...
        if (\Auth::user()->supportTicketCreatorId() == 1) {
            $validator = Validator::make(
                ...
                [
                    ...
                    'priority.*.priority' => 'required|string|max:255',
                    'priority.*.priority_id' => 'required|string|max:255',
                    'priority.*.response_within' => 'required|string|max:255',
                    'priority.*.response_time' => 'required|string|max:255',
                ]
            );
            ...
            return redirect()->route('policiy.index')->with('success', __('policiy updated successfully'));
        } else {
