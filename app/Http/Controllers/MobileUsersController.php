...
class MobileUsersController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $stats = [
            ...
            'total_revenue' => MobileAppPayment::where('status', 'completed')->sum('amount'),
    ...
    public function show($id)
    {
        ...
        $userStats = [
            ...
            'total_payments' => $user->mobilePayments()->sum('amount'),
    ...
    public function statistics()
    {
        $stats = [
            ...
            'total_revenue' => MobileAppPayment::where('status', 'completed')->sum('amount'),
            'revenue_this_month' => MobileAppPayment::where('status', 'completed')
