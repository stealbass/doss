...
use App\Jobs\SendEmployeeCreatedNotification;
...
class EmployeeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Load SMTP configuration and dispatch invitation email to the new employee
        Utility::getSMTPDetails($user->created_by);
        SendEmployeeCreatedNotification::dispatch($user, $request->password);
