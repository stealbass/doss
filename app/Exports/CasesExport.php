    ...
    public function collection()
    {
        if (Auth::user()->can('manage case')) {
            ...
            foreach ($cases as $k => $case) {
                unset($case->your_party, $case->your_party_name, $case->opp_party_name, $case->casetype, $case->casenumber, $case->diarybumber, $case->your_party, $case->your_party_name, $case->opp_party_name, $case->opp_adv, $case->case_docs, $case->journey, $case->motion, $case->created_at, $case->updated_at);
