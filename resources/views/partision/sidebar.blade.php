    ...
    <div class="navbar-wrapper">
        ...
        <div class="navbar-content">
            <ul class="dash-navbar">
                ...
                @can('manage expense')
                    <li class="dash-item dash-hasmenu {{ in_array(Request::segment(1), ['expenses']) ? ' active' : '' }}">
                        <a href="{{ route('expenses.index') }}" class="dash-link">
                            ...
                            <span class="dash-mtext">{{ __('Dépenses/Encaissement') }}</span>
                        </a>
                    </li>
                @endcan
                ...
                @if (\Auth::user()->type != 'super admin')
                    <li class="dash-item {{ \Request::route()->getName() == 'chats' ? ' active' : '' }}">
                        <a href="{{ url('chats') }}"
                            ...
                            <span class="dash-micon"><i class="ti ti-brand-messenger"></i></span>
                ...
                @if (
                    (Auth::user()->super_admin_employee == 1 && array_search('manage support ticket', $premission_arr)) ||
                        Auth::user()->type == 'company')
                    <li class="dash-item dash-hasmenu">
                        <a href="#!" class="dash-link">
                ...
                @if (Auth::user()->type == 'company' ||
                    ...
                    <li class="dash-item dash-hasmenu">
                        <a href="#!" class="dash-link ">
                            ...
                            <span class="dash-mtext">{{ __('Functional Setup') }}</span>
                            <span class="dash-arrow"><i data-feather="chevron-right"></i></span>
                        </a>
                        <ul class="dash-submenu">
                ...
                {{-- Legal Library - Visible to all employees --}}
                ...
                {{-- Document Templates - For SuperAdmin employees with permission --}}
                @if (\Auth::user()->type == 'superAdminEmployee' && (in_array('manage document-template', $premission_arr) || in_array(4, $premission_arr)))
                ...
                {{-- Fiscal Resources - For SuperAdmin employees with permission --}}
                @if (\Auth::user()->type == 'superAdminEmployee' && (in_array('manage fiscal-resources', $premission_arr) || in_array(5, $premission_arr)))
