    ...
    <div class="header-wrapper">
        <div class="me-auto dash-mob-drp">
            <ul class="list-unstyled">
                ...
                <li class="dropdown dash-h-item drp-company">
                    <a class="dash-head-link  me-0 " href="{{ route('user.ticket.create') }}" role="button"
                    ...
                    <div class="dropdown-menu dash-h-dropdown dropdown-menu-end " aria-labelledby="dropdownLanguage">
                        ...
                        @can('create language')
                            ...
                            <a href="#" data-url="{{ route('create.language') }}" data-size="md"
                                ...
                                class="dropdown-item  text-primary text-primary">{{ __('Create Language') }}
                            </a>
                            <div class="dropdown-divider m-0"></div>
                            <a href="{{ route('manage.language', $currantLang) }}"
                                class="dropdown-item text-primary">{{ __('Manage Language') }}
                            </a>
                        @endcan
                    </div>
                </li>
