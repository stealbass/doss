...
@section('page-title', __('Update Advocate'))

@section('breadcrumb')
    <li class="breadcrumb-item">{{ __('Update Advocate') }}</li>
@endsection

@section('content')
    {{ Form::model($advocate, ['route' => ['advocate.update', $advocate->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data', 'class' => 'needs-validation', 'novalidate']) }}
    <div class="row py-3">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-6 ">
                            <div class="form-group">
                                ...
                                {{ Form::text('name', $advocate->getAdvUser->name, ['class' => 'form-control', 'placeholder' => __('Enter Firm/Advocate Name'), 'required' => 'required']) }}
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6">
                            <div class="form-group">
                                {{ Form::label('email', __('Email Address'), ['class' => 'col-form-label']) }}<x-required></x-required>
                                {{ Form::email('email', $advocate->getAdvUser->email, ['class' => 'form-control', 'placeholder' => __('Enter Email'), 'required' => 'required']) }}
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6">
                            <div class="form-group">
