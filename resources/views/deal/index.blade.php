    ...
    @if (Auth::user()->super_admin_employee == 1 ||
        ...
        <div class="row align-items-center">
            <div class="col-md-12 d-flex justify-content-sm-end">
                <div class="text-end justify-content-md-end justify-content-center">
                ...
                <div class="text-end d-flex all-button-box justify-content-md-end justify-content-center">
                    <a href="{{ route('deal.list') }}" class="btn btn-sm btn-primary mx-1" data-bs-toggle="tooltip"
                ...
                @if (
                    (Auth::user()->super_admin_employee == 1 && array_search('manage crm', $premission_arr)) ||
                        ...
                        Auth::user()->type == 'company')
                    <div class="text-sm-end d-flex all-button-box justify-content-sm-end">
                        <a href="#" class="btn btn-sm btn-primary mx-1"data-bs-toggle="tooltip"
                            data-bs-placement="top" title="{{ __('Import') }}"data-size="md" data-ajax-popup="true"
                            data-title="{{ __('Import deal') }}" data-url="{{ route('deals.file.import') }}">
                            <i class="ti ti-file-import text-white"></i>
                        </a>
                    </div>
                    <div class="text-end d-flex all-button-box justify-content-md-end justify-content-center">
                        <a href="#" class="btn btn-sm btn-primary mx-1" data-ajax-popup="true" data-size="lg"
                            data-title="{{ __('Create Deal') }}" data-url="{{ route('deal.create') }}"
                                            ...
                                            <div class="pt-3 ps-3">
                                                @if ($labels)
                                                    @foreach ($labels as $label)
                                                        <span
                                                            class="badge bg-{{ $label->color }} p-1 px-3">{{ $label->name }}</span>
                                                    @endforeach
                                                @endif
