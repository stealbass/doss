...
{{ Form::model($deal, ['route' => ['deal.update', $deal->id], 'class' => 'needs-validation', 'novalidate']) }}
@method('put')
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            {{ Form::number('price', null, ['class' => 'form-control', 'placeholder' => __('Enter Price'), 'min' => 0]) }}
        </div>
        <div class="form-group col-md-6">
        ...
        <div class="form-group col-md-6">
            ...
            {{ Form::select('stage_id', $stages, $deal->stage_id, ['class' => 'form-control multi-select', 'placeholder' => __('Select Stage')]) }}
        </div>
        <div class="form-group col-md-6">
            {{ Form::label('sources', __('Sources'), ['class' => 'col-form-label']) }}
            {{ Form::select('sources[]', $sources, null, ['class' => 'form-control multi-select', 'id' => 'choices-multiple', 'multiple' => '']) }}
