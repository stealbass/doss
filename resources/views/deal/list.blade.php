        ...
        <div class="row align-items-center">
            <div class="col-md-12 d-flex justify-content-sm-end">
                <div class="text-end d-flex all-button-box justify-content-md-end justify-content-center">
                    <a href="{{ route('deal.index') }}" class="btn btn-sm btn-primary mx-1" data-bs-toggle="tooltip"
        ...
        <div class="card shadow-none">
            <div class="card-body table-border-style">
                <div class="table-responsive">
                    <table class="table dataTable data-table" id="pc-dt-simple">
                        <thead>
                            <tr>
                                <th>{{ __('Name') }}</th>
                                <th>{{ __('Price') }}</th>
                                            ...
                                            @if (\Auth::user()->super_admin_employee == '1')
                                                ...
                                                <div class="action-btn me-2">
                                                    <a href="#" class="mx-3 btn btn-sm btn-info align-items-center "
                                                        data-url="{{ route('deal.edit', $deal->id) }}" data-size="lg"
                                                        data-ajax-popup="true" data-title="{{ __('Update Deal') }}"
