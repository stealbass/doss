                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-7" style="padding: 0px; width: 173px;">
                                                            <select class="form-select"
                                                                name="{{ "priority[$priorities->name][response_time]" }}"
                                                                required="">
                                                                <option value="Hour"
                                                                    {{ isset($priorities->policies->response_time) && $priorities->policies->response_time == 'Hour' ? 'selected' : '' }}>
                                                                    {{ __('Hour') }}
                                                                </option>
                                                                <option value="Minute"
                                                                    {{ isset($priorities->policies->response_time) && $priorities->policies->response_time == 'Minute' ? 'selected' : '' }}>
                                                                    {{ __('Minute') }}
                                                                </option>
                                                                <option value="Day"
                                                                    {{ isset($priorities->policies->response_time) && $priorities->policies->response_time == 'Day' ? 'selected' : '' }}>
                                                                    {{ __('Day') }}
                                                                </option>
                                                                <option value="Month"
                                                                    {{ isset($priorities->policies->response_time) && $priorities->policies->response_time == 'Month' ? 'selected' : '' }}>
                                                                    {{ __('Month') }}
                                                                </option>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="row resolve">
                                                        ...
                                                        <div class="col-sm-7" style="padding: 0px; width: 173px;">
                                                            <select
                                                                ...
                                                                required="">
                                                                <option value="Hour"
                                                                    {{ isset($priorities->policies->resolve_time) && $priorities->policies->resolve_time == 'Hour' ? 'selected' : '' }}>
                                                                    {{ __('Hour') }}
                                                                </option>
                                                                <option value="Minute"
                                                                    {{ isset($priorities->policies->resolve_time) && $priorities->policies->resolve_time == 'Minute' ? 'selected' : '' }}>
                                                                    {{ __('Minute') }}
                                                                </option>
                                                                <option value="Day"
                                                                    {{ isset($priorities->policies->resolve_time) && $priorities->policies->resolve_time == 'Day' ? 'selected' : '' }}>
                                                                    {{ __('Day') }}
                                                                </option>
                                                                <option value="Month"
                                                                    {{ isset($priorities->policies->resolve_time) && $priorities->policies->resolve_time == 'Month' ? 'selected' : '' }}>
                                                                    {{ __('Month') }}
                                                                </option>
                                                            </select>
                                                        </div>
