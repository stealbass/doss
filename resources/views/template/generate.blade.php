    ...
    <div class="row">
        <div class="col-12">
            <div class="form-group">
                {{ Form::label('template', __('For What'), ['class' => 'col-form-label', 'class' => 'needs-validation', 'novalidate']) }}</br>
        ...
        <div class="col-6">
            <div class="form-group">
                ...
                <select name="ai_creativity" id="ai_creativity" class="form-select" required>
