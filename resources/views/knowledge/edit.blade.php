...
@section('page-title')
{{ __('Update Knowledge') }} ({{ $knowledge->title }})
@endsection
...
<div class="col-12">
    <div class="card shadow-none rounded-0 border-bottom">
        <div class="card-body">
            ...
            @endif
            <form method="post" action="{{ route('knowledge.update', $knowledge->id) }}" class="needs-validation"
                novalidate>
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <div class="col-sm-12 col-md-12">
                            <input type="text" placeholder="{{ __('Title of the Knowledge') }}" name="title"
                                ...
                                value="{{ $knowledge->title }}" autofocus required>
