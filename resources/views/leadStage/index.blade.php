    ...
    @if (Auth::user()->super_admin_employee == 1 || array_search('manage crm', $premission_arr))
        <div class="text-sm-end d-flex all-button-box justify-content-sm-end">
            <a href="#" class="btn btn-sm btn-primary mx-1" data-ajax-popup="true" data-size="md"
                data-title="{{ __('Create Lead Stage') }}" data-url="{{ route('leadStage.create') }}"
            ...
            <div class="card">
                <div class="card-body">
                                                ...
                                                <span class="float-end">
                                                    <div class="action-btn me-2">
                                                        <a href="#"
                                                            ...
                                                            data-title="{{ __('Update Lead Stage') }}"
                    ...
                    <p class="text-muted mt-4"><strong>{{ __('Note') }} :
                        </strong>{{ __('You can easily change order of lead stage using drag & drop.') }}
                    </p>
                </div>
            </div>
        </div>
