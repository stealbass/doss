        ...
        <div class="row g-0">
            <div class="col-12">
                <div
                    ...
                    <a @can('manage case') href="{{ route('cases.index') }}" @endcan>
                    ...
                    <a @can('manage advocate') href="{{ route('advocate.index') }}" @endcan>
                        <div class="col border-end border-bottom">
                            <div class="p-3">
                                <div class="d-flex justify-content-between mb-3">
                    ...
                    <a @can('manage document') href="{{ route('documents.index') }}" @endcan>
                        <div class="col border-end border-bottom">
                            <div class="p-3">
                                <div class="d-flex justify-content-between mb-3">
                    ...
                    <a @can('manage member') href="{{ route('users.index') }}"  @endcan>
                        <div class="col border-end border-bottom">
                            <div class="p-3">
                                <div class="d-flex justify-content-between mb-3">
                    ...
                    <a @can('manage todo') href="{{ route('to-do.index') }}" @endcan>
                        <div class="col border-end border-bottom">
                            <div class="p-3">
                                <div class="d-flex justify-content-between mb-3">
                ...
                <div class="col-12 col-md-6">
                    <div class="card shadow-none bg-transparent border-end border-bottom rounded-0">
                        <div class="card-header">
                            <h5 class="mb-0">{{ __('Storage Status') }}
                                <small>
                                    ({{ $users->storage_limit . 'MB' }} / {{ $plan->storage_limit . 'MB' }})
                                </small>
                            </h5>
                        </div>
                ...
                <div class="card shadow-none">
                    <div class="card-header ">
                        <div class="row align-items-center justify-content-between">
                            ...
                            @if (App\Models\Utility::getValByName('is_enabled') == 'on')
                                <div class="col-auto">
