                                                ...
                                                @can('delete case')
                                                    <div class="action-btn me-2">
                                                        <a href="#"
                                                            ...
                                                            data-confirm-yes="cases-delete-form-{{ $case->id }}"
                                                    ...
                                                    @if (Auth::user()->type != 'client')
                                                        ...
                                                        <div class="action-btn me-2">
                                                            <a href="#"
                                                                ...
                                                                data-confirm="{{ __('Are You Sure?') }}"
                                                                data-text="{{ __('This action can not be undone. Do you want to continue?') }}"
                                                                data-confirm-yes="hearing-delete-form-{{ $hearing->id }}"
                                                                title="{{ __('Delete') }}" data-bs-toggle="tooltip"
                                                                data-bs-placement="top">
                                                                <i class="ti ti-trash"></i>
                                                            </a>
                                                        ...
                                                        {!! Form::open([
                                                            ...
                                                            'id' => 'hearing-delete-form-' . $hearing->id,
                                                        ]) !!}
                                                        {!! Form::close() !!}
                                                    @endif
                                                </td>
                            ...
                            <table class="table dataTable data-table">
                                ...
                                <tbody>
                                    @foreach ($bills as $bill)
                                        <tr>
                                            <td>
                                                <a href="{{ route('bills.show', $bill->id) }}" class="btn btn-sm">
                                                    {{ $bill->bill_number }}
                                                </a>
                                            </td>
                                                ...
                                                @can('delete bill')
                                                    <div class="action-btn me-2">
                                                        <a href="#"
                                                            class="mx-3 btn btn-sm btn-danger align-items-center bs-pass-para"
                                                            data-confirm="{{ __('Are You Sure?') }}"
                                                            data-confirm-yes="bills-delete-form-{{ $bill->id }}"
                                                            title="{{ __('Delete') }}" data-bs-toggle="tooltip"
                                                            data-text="{{ __('This action can not be undone. Do you want to continue?') }}"
                                                            data-bs-placement="top">
                                                            <i class="ti ti-trash"></i>
                                                ...
                                                @can('delete feereceived')
                                                    <div class="action-btn me-2">
                                                        <a href="#"
                                                            ...
                                                            data-confirm="{{ __('Are You Sure?') }}"
                                                            data-text="{{ __('This action can not be undone. Do you want to continue?') }}"
                                                            data-confirm-yes="fee-receive-delete-form-{{ $expense->id }}"
                                                            title="{{ __('Delete') }}" data-bs-toggle="tooltip"
                                                            data-bs-placement="top">
                                                            <i class="ti ti-trash"></i>
                                                        </a>
                                                    ...
                                                    {!! Form::open([
                                                        ...
                                                        'id' => 'fee-receive-delete-form-' . $expense->id,
                                                    ]) !!}
                                                    {!! Form::close() !!}
                                                @endcan
                                            </td>
