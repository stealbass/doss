        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                @if ($role->name != 'advocate' && $role->name != 'client')
                    {{ Form::text('name', null, ['class' => 'form-control', 'placeholder' => __('Enter Role Name'), $role->name == 'advocate' ? 'readonly' : '', 'required']) }}
                @else
                    {{ Form::text('name', null, ['class' => 'form-control', 'placeholder' => __('Enter Role Name'), 'required' => 'required', 'disabled' => 'disabled']) }}
                ...
                @if (!empty($permissions))
                    <div class="table-border-style">
                        <label for="permissions"
                            class="col-form-label">{{ __('Assign Permission to Roles') }}</label><x-required></x-required>
