{{ Form::open(['route' => 'fee-receive.store', 'method' => 'post', 'enctype' => 'multipart/form-data', 'class' => 'needs-validation', 'novalidate']) }}
<div class="modal-body">
    <div class="row">
        <div class="form-group col-md-12">
            {!! Form::label('case', __('Case'), ['class' => 'form-label']) !!}<x-required></x-required>
            <select class="form-control multi-select" name="case" id="case" placeholder="Select Case" required>
        ...
        <div class="form-group col-md-12">
            {!! Form::label('money', __('Received Fee'), ['class' => 'form-label']) !!}<x-required></x-required>
