    ...
    @can('create todo')
        <div class="text-sm-end d-flex all-button-box justify-content-sm-end">
            <a href="#" class="btn btn-sm btn-primary mx-1" data-ajax-popup="true" data-size="md"
                data-title="{{ __('Create To-Do') }}" data-url="{{ route('to-do.create') }}" data-toggle="tooltip"
                title="{{ __('Create') }}" data-bs-original-title="{{ __('Create') }}" data-bs-placement="top"
...
@section('content')
    <div class="row p-0 g-0 justify-content-center">
        <div class="card shadow-none rounded-0 border-bottom">
            <div class="card-body">
                <div class="d-flex align-items-center justify-content-end">
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-6 col-sm-11 col-10 mx-2">
                        <form action="{{ route('to-do.index') }}" method="GET" id="priority-form">
                            <select name="filter" class="form-control select multi-select" id="priorities">
        ...
        <div class="card table-card shadow-none bg-transparent">
                        ...
                        <table class="table dataTable data-table">
                            ...
                            <tbody>
                                @foreach ($todos as $todo)
                                    <tr>
                                        <td>{{ $todo->title ?? '-' }}</td>
                                        <td>{{ $todo->assigned_date ?? $todo->start_date ?? '-' }}</td>
                                        <td>{{ $todo->due_date }}</td>
                                                ...
                                                @if ($todo['status'] == 1)
                                                    <div class="action-btn me-2">
                                                        <a href="#" class="mx-3 btn btn-sm btn-info align-items-center "
                                                            ...
                                                            data-ajax-popup="true" data-title="{{ __('Update To-Do') }}"
