        ...
        <div class="col-lg-12">
            <div class="">
                <dl class="row">
                    ...
                    <dd class="col-md-8"><span class="text-md">{{ App\Models\Cases::getCasesById($todo->relate_to) }}</span></dd>
                    ...
                    @if (!empty($todo->completed_by))
                        ...
                        <dd class="col-md-8"><span class="text-md">{{ App\Models\User::getTeams($todo->completed_by) }}</span></dd>
                    @endif
