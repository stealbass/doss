{{ Form::open(['route' => 'cause.store', 'method' => 'post', 'enctype' => 'multipart/form-data', 'class' => 'needs-validation', 'novalidate']) }}
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-12">
            {!! Form::label('advocate_name', __('Advocate Name'), ['class' => 'form-label', 'id' => 'adv_label']) !!}<x-required></x-required>
