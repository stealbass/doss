            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-12">
                            {!! Form::label('country', __('Country / Jurisdiction'), ['class' => 'form-label']) !!}<span class="text-danger">*</span>
                            {!! Form::select('country', [
                                '' => __('Select Country'),
                                'BJ' => '🇧🇯 ' . __('Bénin'),
                                'BF' => '🇧🇫 ' . __('Burkina Faso'),
                            ...
                            <small class="form-text text-muted">{{ __('Select the country/jurisdiction for this legal document') }}</small>
                        </div>
                        <div class="form-group col-md-12">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <small class="form-text text-muted">{{ __('Leave empty to keep the current file. Maximum file size: 200MB.') }}</small>
                        </div>
                    </div>
                </div>
