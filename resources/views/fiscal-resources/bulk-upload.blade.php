...
@section('page-title', __('Import Multiple Fiscal Resources'))

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('fiscal-resources.index') }}">{{ __('Fiscal Resources') }}</a></li>
    <li class="breadcrumb-item">{{ __('Import Multiple Resources') }}</li>
@endsection
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h5 class="mb-0">{{ __('Import Multiple Fiscal & Social Resources') }}</h5>
                            <small class="text-muted">{{ __('Upload several resources at once') }}</small>
                        </div>
                        <div>
                ...
                <form action="{{ route('fiscal-resources.bulk-upload.store') }}"
                      method="POST"
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select name="category_id" id="fiscalCategorySelect" class="form-control" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-label"><strong>{{ __('Resource Type') }} <span class="text-danger">*</span></strong></label>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="form-label"><strong>{{ __('Year') }} <span class="text-danger">*</span></strong></label>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="form-label"><strong>{{ __('Version') }}</strong></label>
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <button type="submit" class="btn btn-success btn-lg" id="uploadBtn" disabled>
                                <i class="ti ti-upload"></i> {{ __('Upload All Resources') }}
                            </button>
                        </div>
                    </div>
                </form>
