    ...
    @can('create coupon')
        <div class="col-md-12 d-flex justify-content-sm-end">
            <a href="#" class="btn btn-sm btn-primary btn-icon" title="{{ __('Create') }}" data-bs-toggle="tooltip"
                data-bs-placement="top" data-ajax-popup="true" data-title="{{ __('Create Coupon') }}"
                        ...
                        <table class="table dataTable data-table">
                            ...
                            <tbody>
                                @foreach ($coupons as $coupon)
                                    <tr class="">
                                        <td>
                                            <a href="{{ route('coupons.show', $coupon->id) }}" class="btn btn-sm"
                                                title="{{ __('Detail') }}">
                                                {{ $coupon->name }}
                                            </a>
                                        </td>
                                            ...
                                            @can('edit coupon')
                                                <div class="action-btn me-2">
                                                    <a href="#" class="mx-3 btn btn-sm btn-info align-items-center"
                                                        ...
                                                        data-ajax-popup="true" data-title="{{ __('Update Coupon') }}"
                                                        data-size="md"><i class="ti ti-pencil"></i>
                                                    </a>
                                                </div>
                                            @endcan
                                            @can('delete coupon')
                                                <div class="action-btn me-2">
                                                    ...
                                                    <a href="#"
                                                        class="bs-pass-para mx-3 btn btn-sm btn-danger align-items-center"
