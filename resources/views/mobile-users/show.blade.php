                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div class="fw-bold">{{ $subscription->starts_at->format('d/m/Y H:i') }}</div>
                                </div>
                                <div class="mb-3">
                                    <label class="text-muted small">{{ __('Expires At') }}</label>
                                    <div class="fw-bold">{{ $subscription->expires_at->format('d/m/Y H:i') }}</div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="fw-bold">{{ number_format($subscription->plan->monthly_price, 0) }} CFA/{{ __('month') }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
