        ...
        <div class="col-lg-12">
            ...
            <div class="">
                <dl class="row">
                    ...
                    <dd class="col-md-8"><span class="text-md">{{ App\Models\Cases::getCasesById($timesheet->case) ?? '-'}}</span></dd>
                    ...
                    <dd class="col-md-8"><span class="text-md">{{ App\Models\User::getTeams($timesheet->member) ?? '-' }}</span></dd>
                </dl>
            </div>
