                    ...
                    onSuccess(payload) {
                        if (payload.token) {
                            ...
                            $.ajax({
                                ...
                                error: function(xhr) {
                                    $(".loader-wrapper").addClass('d-none');
                                    show_toastr('Error', xhr.responseJSON.error || 'Payment Failed', 'error');
                                },
                            });
                        }
                    },
            ...
            <div class="col-xl-3 border-end border-bottom">
                <div class="card shadow-none bg-transparent sticky-top">
                    ...
                    <div class="list-group list-group-flush rounded-0" id="useradd-sidenav">
                        ...
                        @endif
                        @if (isset($admin_payment_setting['is_powertranz_enabled']) && $admin_payment_setting['is_powertranz_enabled'] == 'on')
                            <a href="#powertranz_payment"
                                class="list-group-item list-group-item-action border-0">{{ __('PowerTranz') }}<div
                                    class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                        @endif
                        @if (isset($admin_payment_setting['is_payu_enabled']) && $admin_payment_setting['is_payu_enabled'] == 'on')
                            <a href="#payu_payment"
                    ...
                    <div class="card shadow-none rounded-0 border price-card price-1 wow animate__fadeInUp"
                        ...
                        <div class="card-body">
                            ...
                            <span
                                class="mb-4 f-w-600 p-price">{{ $admin_payment_setting['currency_symbol'] ? $admin_payment_setting['currency_symbol'] : '$' }}
                            ...
                            <ul class="list-unstyled my-4">
                                ...
                                @if ($plan->trial != 0)
                                    <li>
                                        <span class="theme-avtar">
                                            <i class="text-primary ti ti-circle-plus"></i></span>
                                        {{ $plan->storage_limit != null && $plan->trial != 0 ? $plan->trial_days : '0' }}
                                        {{ __('Trial Days') }}
                                    </li>
                                @endif
                            </ul>
            ...
            <div class="col-xl-9">
                                ...
                                <form>
                                    ...
                                    <form>
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-6 text-right ">
                                                <b>{{ __('Net Amount') }}</b> :
                                                {{ $admin_payment_setting['currency_symbol'] ? $admin_payment_setting['currency_symbol'] : '$' }}<span
                ...
                @if (isset($admin_payment_setting['is_skrill_enabled']) && $admin_payment_setting['is_skrill_enabled'] == 'on')
                    <div id="skrill-payment" class="card  shadow-none rounded-0 border-bottom ">
                        <form role="form" action="{{ route('plan.pay.with.skrill', ['id' => encrypt($plan->id)]) }}"
                            method="post" class="w3-container w3-display-middle w3-card-4" id="skrill-payment-form">
                            @csrf
                            <div class="card-header">
                                <h5>{{ __('Skrill') }}</h5>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="float-end">
                                                    ...
                                                    <button class="btn btn-primary d-flex align-items-center"
                                                        ...
                                                        {{ __('Pay Now') }}
                                                        (<span
                                                            class="cashfree-final-price">{{ $admin_payment_setting['currency_symbol'] ? $admin_payment_setting['currency_symbol'] : '$' }}{{ $plan->price }}</span>)
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="float-end">
                                                    ...
                                                    <button class="btn btn-primary d-flex align-items-center"
                                                        ...
                                                        {{ __('Pay Now') }}
                                                        (<span
                                                            class="midtrans-final-price">{{ $admin_payment_setting['currency_symbol'] ? $admin_payment_setting['currency_symbol'] : '$' }}{{ $plan->price }}</span>)
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="float-end">
                                                    ...
                                                    <button class="btn btn-primary d-flex align-items-center"
                                                        ...
                                                        {{ __('Pay Now') }}
                                                        (<span
                                                            class="xendit-final-price">{{ $admin_payment_setting['currency_symbol'] ? $admin_payment_setting['currency_symbol'] : '$' }}{{ $plan->price }}</span>)
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="text-end">
                                        ...
                                        <button type="submit" data-from="paiementpro" value="{{ __('Pay Now') }}"
                                            ...
                                            class="btn btn-xs btn-primary">{{ __('Pay Now') }} (<span
                                                class="paiementpro-final-price">{{ $admin_payment_setting['currency_symbol'] ? $admin_payment_setting['currency_symbol'] : '$' }}{{ $plan->price }}</span>)</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                                ...
                                <div class="col-sm-12 my-2 px-2">
                                    <div class="text-end">
                                        ...
                                        <button type="submit" data-from="nepalste" value="{{ __('Pay Now') }}"
                                            id="pay_with_nepalste" class="btn btn-xs btn-primary">{{ __('Pay Now') }}
                                            (<span
                                                class="nepalste-final-price">{{ $admin_payment_setting['currency_symbol'] ? $admin_payment_setting['currency_symbol'] : '$' }}{{ $plan->price }}</span>)</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                                ...
                                <div class="col-sm-12 my-2 px-2">
                                    <div class="text-end">
                                        ...
                                        <button type="submit" data-from="cinetpay" value="{{ __('Pay Now') }}"
                                            id="pay_with_cinetpay" class="btn btn-xs btn-primary">{{ __('Pay Now') }}
                                            (<span
                                                class="cinetpay-final-price">{{ $admin_payment_setting['currency_symbol'] ? $admin_payment_setting['currency_symbol'] : '$' }}{{ $plan->price }}</span>)</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                                ...
                                <div class="col-sm-12 my-2 px-2">
                                    <div class="text-end">
                                        ...
                                        <button type="submit" data-from="fedapay" value="{{ __('Pay Now') }}"
                                            id="pay_with_fedapay" class="btn btn-xs btn-primary">{{ __('Pay Now') }}
                                            (<span
                                                class="fedapay-final-price">{{ $admin_payment_setting['currency_symbol'] ? $admin_payment_setting['currency_symbol'] : '$' }}{{ $plan->price }}</span>)</button>
                                    </div>
                                </div>
                ...
                {{-- Tap --}}
                @if (isset($admin_payment_setting['is_tap_enabled']) && $admin_payment_setting['is_tap_enabled'] == 'on')
                    <div id="tap_payment" class="card shadow-none rounded-0 border-bottom">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-2 coupon-apply-btn mt-4">
                                            <div class="form-group apply-tap-btn-coupon">
                                                <a href="#"
                                                    class="btn btn-primary align-items-center apply-coupon"
                                                    data-from="tap">{{ __('Apply') }}</a>
                                            </div>
                                        </div>
                                        <div class="col-12 text-right tap-coupon-tr" style="display: none">
                                            <b>{{ __('Coupon Discount') }}</b> : <b class="tap-coupon-price"></b>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12 my-2 px-2">
                                    <div class="text-end">
                                        ...
                                        <button type="submit" data-from="tap" value="{{ __('Pay Now') }}"
                                            id="pay_with_tap" class="btn btn-xs btn-primary">{{ __('Pay Now') }}
                                            (<span
                                                class="tap-final-price">{{ $admin_payment_setting['currency_symbol'] ? $admin_payment_setting['currency_symbol'] : '$' }}{{ $plan->price }}</span>)</button>
                                    </div>
                                </div>
                ...
                @if (isset($admin_payment_setting['is_authorizenet_enabled']) &&
                        $admin_payment_setting['is_authorizenet_enabled'] == 'on')
                    <div id="authorizenet_payment" class="card shadow-none rounded-0 border-bottom">
                        <form role="form" action="{{ route('plan.pay.with.authorizenet') }}" method="post"
                            id="authorizenet-payment-form" class="w3-container w3-display-middle w3-card-4">
                            @csrf
                            <div class="card-header">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-2 coupon-apply-btn mt-4">
                                            <div class="form-group apply-authorizenet-btn-coupon">
                                                <a href="#"
                                                    class="btn btn-primary align-items-center apply-coupon">{{ __('Apply') }}</a>
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-12 my-2 px-2">
                                    <div class="text-end">
                                        ...
                                        <button class="btn btn-xs btn-primary" type="submit"
                                            ...
                                            {{ __('Pay Now') }}
                                            (<span
                                                class="authorizenet-final-price">{{ $admin_payment_setting['currency_symbol'] ? $admin_payment_setting['currency_symbol'] : '$' }}{{ $plan->price }}</span>)
                                        </button>
                                    </div>
                                </div>
                            </div>
                ...
                {{-- Ozow Payment Start --}}
                @if (isset($admin_payment_setting['is_ozow_enabled']) && $admin_payment_setting['is_ozow_enabled'] == 'on')
                    <div id="ozow_payment" class="card shadow-none rounded-0 border-bottom">
                        <form role="form" action="{{ route('plan.pay.with.ozow') }}" method="post"
                            ...
                            <div class="card-header">
                                <h5>{{ __('Ozow') }}</h5>
                                <p class="text-sm text-muted">{{ __('Details about your plan Ozow payment') }}</p>
                            </div>
                            <div class="card-body">
                                <div class="row mt-3">
                                    <div class="col-md-10">
                                ...
                                <div class="col-sm-12 my-2 px-2">
                                    <div class="text-end">
                                        <input type="hidden" name="plan_id"
                                            value="{{ \Illuminate\Support\Facades\Crypt::encrypt($plan->id) }}">
                                        <button class="btn btn-xs btn-primary" type="submit" id="pay_with_ozow">
                                            {{ __('Pay Now') }}
                                            (<span
                                                class="ozow-final-price">{{ $admin_payment_setting['currency_symbol'] ? $admin_payment_setting['currency_symbol'] : '$' }}{{ $plan->price }}</span>)
                                        </button>
                                    </div>
                                </div>
                            </div>
                ...
                <!-- Khalti Payment -->
                @if (isset($admin_payment_setting['is_khalti_enabled']) && $admin_payment_setting['is_khalti_enabled'] == 'on')
                    <div id="khalti_payment" class="card shadow-none rounded-0 border-bottom">
                        <form role="form" action="{{ route('plan.pay.with.khalti') }}" method="post"
                            ...
                            <div class="card-header">
                                <h5>{{ __('Khalti') }}</h5>
                                <p class="text-sm text-muted">{{ __('Details about your plan Khalti payment') }}</p>
                            </div>

                            <div class="px-3 payment-box">
                                    ...
                                    <div class="col-12 mt-4 mb-3">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-lg-2 col-mg-2 col-sm-12 col-xs-12">
                                                <a href="#"
                                                    class="btn btn-print-invoice btn-primary m-r-10 apply-coupon">{{ __('Apply') }}</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-12 my-2 px-4">
                                <div class="text-end">
                                    <input type="hidden" name="plan_id" class="khalti_plan_id"
                                        value="{{ \Illuminate\Support\Facades\Crypt::encrypt($plan->id) }}">
                                    <button class="btn btn-primary" type="submit" id="pay_with_khalti">
                                        {{ __('Pay Now') }}
                                        (<span
                                            class="khalti-final-price">{{ $admin_payment_setting['currency_symbol'] ? $admin_payment_setting['currency_symbol'] : '$' }}{{ $plan->price }}</span>)
                                    </button>
                                </div>
                            </div>
                        </form>
                ...
                <!-- PowerTranz Payment -->
                @if (isset($admin_payment_setting['is_powertranz_enabled']) && $admin_payment_setting['is_powertranz_enabled'] == 'on')
                    <div class="card shadow-none rounded-0 border-bottom" id="powertranz_payment">
                        <form role="form" action="{{ route('plan.pay.with.powertranz') }}" method="post"
                            id="powertranz-payment-form" class="w3-container w3-display-middle w3-card-4">
                            @csrf
                            <div class="card-header">
                                <h5>{{ __('PowerTranz') }}</h5>
                                <small class="text-muted">{{ __('Details about your plan PowerTranz payment') }}</small>
                            </div>
                            <div class="card-body">
                                <div class="row mt-3">
                                    <div class="col-md-10">
                                    ...
                                    <div class="col-md-2 coupon-apply-btn">
                                        <div class="form-group apply-powertranz-btn-coupon mt-4">
                                            <a href="#" class="btn btn-primary align-items-center apply-coupon"
                                                data-from="powertranz">{{ __('Apply') }}</a>
                                        </div>
                                    </div>

                                    <div class="col-12 text-right powertranz-coupon-tr" style="display: none">
                                        <b>{{ __('Coupon Discount') }}</b> : <b class="powertranz-coupon-price"></b>
                                    </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="float-end">
                                                ...
                                                <button class="btn btn-primary d-flex align-items-center" type="submit"
                                                    id="pay_with_powertranz">
                                                    <i class="mdi mdi-cash-multiple mr-1"></i> {{ __('Pay Now') }}
                                                    (<span class="powertranz-final-price">
                ...
                @endif
                <!-- PowerTranz Payment End-->
                <!-- PayU Payment -->
                @if (isset($admin_payment_setting['is_payu_enabled']) && $admin_payment_setting['is_payu_enabled'] == 'on')
                    <div class="card shadow-none rounded-0 border-bottom" id="payu_payment">
                        <form role="form" action="{{ route('payu.plan.pay') }}" method="post"
                            id="payu-payment-form" class="w3-container w3-display-middle w3-card-4">
                            @csrf
                            <div class="card-header">
                                <h5>{{ __('PayU') }}</h5>
                                <small class="text-muted">{{ __('Details about your plan PayU payment') }}</small>
                            </div>
                            <div class="card-body">
                                <div class="row mt-3">
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            <label for="payu_coupon" class="form-label">{{ __('Coupon') }}</label>
                                    ...
                                    <div class="col-md-2 coupon-apply-btn">
                                        <div class="form-group apply-payu-btn-coupon mt-4">
                                            <a href="#" class="btn btn-primary align-items-center apply-coupon"
                                                data-from="payu">{{ __('Apply') }}</a>
                                        </div>
                                    </div>

                                    <div class="col-12 text-right payu-coupon-tr" style="display: none">
                                        <b>{{ __('Coupon Discount') }}</b> : <b class="payu-coupon-price"></b>
                                    </div>
