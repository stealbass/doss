    ...
    @can('create court')
        <div class="text-sm-end d-flex all-button-box justify-content-sm-end">
            <a href="#" class="btn btn-sm btn-primary mx-1" data-ajax-popup="true" data-size="md"
                data-title="{{ __('Create Courts/Tribunal') }}" data-url="{{ route('courts.create') }}"
                                    ...
                                    <tr>
                                        <td>
                                            <a href="#" class="mx-3 btn btn-sm d-inline-flex align-items-center "
                                                data-url="{{ route('courts.edit', $court->id) }}" data-size="md"
                                                data-ajax-popup="true" data-title="{{ __('Update Court') }}">
                                                {{ $court->name ?? '-' }}
                                            </a>
                                        </td>
                                        <td> {{ $court->type ?? '-' }} </td>
                                            ...
                                            @can('edit court')
                                                <div class="action-btn me-2">
                                                    <a href="#" class="mx-3 btn btn-sm btn-info align-items-center "
                                                        data-url="{{ route('courts.edit', $court->id) }}" data-size="md"
                                                        data-ajax-popup="true" data-title="{{ __('Update Courts/Tribunal') }}"
