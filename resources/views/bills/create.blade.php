...
@section('breadcrumb')
<li class="breadcrumb-item">{{ __('Create Bill') }}</li>
@endsection
        ...
        <div class="p-3">
            <div>
                <div class="card shadow-none bg-transparent border rounded-0 mb-3">
                    <div class="card-body">
                        {{ Form::open(['route' => 'bills.store', 'class' => 'w-100 needs-validation', 'novalidate']) }}
                        <div class="col-12">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                    ...
                                    <div class="form-group d-none" id="advocate_div">
                                        {{ Form::label('advocate', __('Advocate'), ['class' => 'form-label']) }}
                                        {{ Form::select('advocate', $advocates, '', ['class' => 'form-control item multi-select', 'id' => 'selected-advocate', 'required' => 'required']) }}
                                    ...
                                    <div class="form-group" id="custom_advocate_div">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <span>
                                                    {{ Utility::getcompanydetailValByName('address') }}
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="form-icon-user">
                                                    ...
                                                    {{ Form::text('title', '', ['class' => 'form-control', 'placeholder' => __('Enter Title'), 'required' => 'required']) }}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="form-icon-user">
                                                    <input type="text" class="form-control"
                                                        value="{{ $invoice_number }}" name="bill_number"
