...
@section('page-title', __('Update Bill'))

@section('action-button')
    <div class="text-sm-end d-flex all-button-box justify-content-sm-end">
        @can('view bill')
            <a href="{{ route('bills.show', $bill->id) }}" class="btn btn-sm btn-primary mx-1" title="{{ __('View') }}"
...
@section('breadcrumb')
    <li class="breadcrumb-item">{{ __('Update Bill') }}</li>
@endsection
                ...
                <div class="col-12 ">
                    <div class="text-end">
                        <a href="#" class="btn btn-sm btn-primary" data-size="medium" data-ajax-popup-over="true"
                            data-url="{{ route('generate', ['bill']) }}" data-bs-toggle="tooltip" data-bs-placement="top"
            ...
            <div class="p-3">
                <div>
                    <div class="card shadow-none bg-transparent border rounded-0 mb-3">
                        <div class="card-body">
                            {{ Form::model($bill, ['route' => ['bills.update', $bill->id], 'class' => 'w-100 needs-validation', 'novalidate', 'method' => 'put']) }}
                            <div class="col-12">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                        ...
                                        <div class="form-group" id="advocate_div">
                                            {{ Form::label('advocate', __('Advocate'), ['class' => 'form-label']) }}
                                            {{ Form::select('advocate', $advocates, $bill->advocate, ['class' => 'form-control multi-select item', 'id' => 'selected-advocate', 'required' => 'required']) }}
                                            <div class="text-xs mt-1">
                                            Create advocate. <a class="dash-link" href="{{ route('advocate.index') }}"><b>Click here</b></a>
                                        </div>
                                        </div>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="text-xs mt-1">
                                            Create client. <a class="dash-link" href="{{ route('client.index') }}"><b>Click here</b></a>
                                        </div>
                                        </div>
                                        ...
                                        <div class="row flex-column items-end align-items-end">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-icon-user">
                                                        {{ Form::text('bill_number', null, ['class' => 'form-control', 'required' => 'required', 'placeholder' => __('Enter Bill Number')]) }}
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="modal-footer mt-3">
                                <a href="{{ url('/bills') }}" class="btn btn-secondary mx-1"> {{ __('Cancel') }} </a>
...
@push('custom-script')
    <script>
        $(document).ready(function() {
            ...
            $('#subtotal').val('{{ $bill->subtotal }}')
            $('#total_tax').val('{{ $bill->total_tax }}')
            $('#total_disc').val('{{ $bill->total_disc }}')
