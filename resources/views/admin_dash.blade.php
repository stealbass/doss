...
@section('content')
    <div class="col-sm-12">
        <div class="row g-0">
            <div class="col-12">
                <div class="row overflow-hidden g-0 pt-0 row-cols-1  row-cols-md-2 row-cols-xxl-3 row-cols-lg-3 row-cols-sm-2">
                    <a @can('manage user') href="{{ route('users.list') }}" @endcan>
                    ...
                    <a @can('manage order') href="{{ route('order.index') }}" @endcan>
                        <div class="col border-end border-bottom">
                            <div class="p-3">
                                <div class="d-flex justify-content-between mb-3">
                                    ...
                                    <div>
                                        <h5 class="mb-0 text-muted">{{ __('Total Order Amount') }} :
                                            {{ number_format($user['total_orders_price'], 0, '', ' ') }}
                                        </h5>
                                    </div>
                                </div>
                                <h5 class="mb-0">
                                    {{ __('Total Orders') }} : {{ number_format($user['total_orders']) }}
                                </h5>
                            </div>
                        </div>
                    </a>
                    <a @if (\Auth::user()->type == 'super admin') href="{{ route('plans.index') }}" @endif>
                        <div class="col border-end border-bottom">
                            <div class="p-3">
                                <div class="d-flex justify-content-between mb-3">
                                ...
                                <h5 class="mb-0">
                                    {{ __('Total Plans') }} : {{ number_format($user['total_plan']) }}
                                </h5>
                            </div>
                        </div>
                    </a>
