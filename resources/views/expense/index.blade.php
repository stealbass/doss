        ...
        <div class="col-xl-12">
            <div class="card shadow-none">
                <div class="card-body table-border-style">
                    <!-- Filtres de recherche et date -->
                    <form method="GET" action="{{ route('expenses.index') }}" class="mb-3">
                        <div class="row align-items-end">
                            <div class="col-md-4">
                                <label for="search" class="form-label">{{ __('Search') }}</label>
                                <input type="text" name="search" id="search" class="form-control" value="{{ request('search') }}" placeholder="{{ __('Search by particulars, amount...') }}">
                            </div>
                            <div class="col-md-3">
                    ...
                    <div class="table-responsive">
                        <table class="table dataTable data-table">
                            ...
                            <tbody>
                                ...
                                @foreach ($expenses as $expense)
                                    @php
                                        if ($expense->type == 'income') {
                                            $total_income += $expense->money;
                                        } else {
                                            $total_expense += $expense->money;
                                        }
                                    @endphp
                                    <tr>
                                        <td>
                                ...
                                @endforeach
                                <tr>
                                    <td colspan="4" class="text-end"><strong>{{ __('Total Expenses') }}</strong></td>
                                    <td><strong>{{ $total_expense }}</strong></td>
                                    <td colspan="3"></td>
                                </tr>
                                <tr>
                                    <td colspan="4" class="text-end"><strong>{{ __('Total Incomes') }}</strong></td>
