    ...
    <div class="row">
        ...
        <div class="form-group col-md-12">
            ...
            {!! Form::number('money', null, [
                'class' => 'form-control',
                'placeholder' => __('Enter Money Spent'),
                'required' => 'required',
            ]) !!}
        </div>
        <div class="form-group col-md-12">
        ...
        <div class="form-group col-md-12">
            {!! Form::label('member', __('Advocate/Member'), ['class' => 'form-label']) !!}<x-required></x-required>
            <div id="advocate_div">
                <select class="form-control multi-select" name="member" id="member" required>
                </select>
            </div>
        </div>
        <div class="form-group col-md-12">
