                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        {{ Form::text('pinecone_environment', $settings->pinecone_environment, ['class' => 'form-control', 'placeholder' => 'aped-4627']) }}
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        {{ Form::label('pinecone_host', __('Host (Optional)'), ['class' => 'form-label']) }}
                                        {{ Form::text('pinecone_host', $settings->pinecone_host, ['class' => 'form-control', 'placeholder' => 'dossy-legal-docs-7udtg21.svc.aped-4627-b74a.pinecone.io']) }}
                                        <small class="text-muted">{{ __('Leave empty to auto-generate from index and environment') }}</small>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group mb-4">
                                <div class="form-check form-switch">
                                    {{ Form::checkbox('pinecone_verify_ssl', 1, $settings->pinecone_verify_ssl ?? true, ['class' => 'form-check-input', 'id' => 'pinecone_verify_ssl']) }}
                                    {{ Form::label('pinecone_verify_ssl', __('Verify SSL Certificate'), ['class' => 'form-check-label']) }}
                                    <small class="d-block text-muted">{{ __('Recommended: Keep enabled for production') }}</small>
                                </div>
                            </div>
