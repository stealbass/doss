    ...
    @if (
        ...
        <div class="row align-items-center">
            <div class="col-md-12 d-flex justify-content-sm-end">
                ...
                <div class="text-end d-flex all-button-box justify-content-md-end justify-content-center">
                    <a href="{{ route('lead.list') }}" class="btn btn-sm btn-primary mx-1" data-bs-toggle="tooltip"
                                            ...
                                            <div class="pt-3 ps-3">
                                                @if ($labels)
                                                    @foreach ($labels as $label)
                                                        <span class="badge bg-{{ $label->color }} ml-1">
                                                            {{ $label->name }}
                                                        </span>
                                                    @endforeach
                                                @endif
                                                <div class="card-header border-0 pb-0 position-relative">
                                                    <h5>
                                                        <a href="{{ route('lead.show', \Crypt::encrypt($lead->id)) }}"
                                                            ...
                                                            data-bs-original-title="{{ __('Lead Detail') }}">{{ $lead->name }}
                                                        </a>
                                                    </h5>
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <ul class="list-inline mb-0">
                                                            <li class="list-inline-item d-inline-flex align-items-center">
                                                                ...
                                                                {{ \Auth::user()->dateFormat($lead->date) }}
                                                            </li>
                                                        </ul>
