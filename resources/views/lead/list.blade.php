        ...
        <div class="row align-items-center">
            <div class="col-md-12 d-flex justify-content-sm-end">
                <div class="text-end d-flex all-button-box justify-content-md-end justify-content-center">
                    <a href="{{ route('lead.index') }}" class="btn btn-sm btn-primary mx-1" data-bs-toggle="tooltip"
                        data-bs-original-title="{{ __('Kanban View') }}">
                        <i class="ti ti-layout-kanban text-white">
                        </i>
                    </a>
                </div>
                                                ...
                                                @if (Auth::user()->type != 'company')
                                                    <div class="action-btn me-2">
                                                        <a href="#"
                                                            ...
                                                            data-url="{{ route('lead.edit', $lead->id) }}" data-size="lg"
                                                            data-ajax-popup="true" data-title="{{ __('Update Lead') }}"
