{{ Form::model($lead, ['route' => ['lead.convert.to.deal', $lead->id], 'method' => 'POST', 'class' => 'needs-validation', 'novalidate']) }}
<div class="modal-body">
    <div class="row">
        <div class="col-6">
            <div class="form-group">
                {{ Form::label('name', __('Deal Name'), ['class' => 'col-form-label']) }}<x-required></x-required>
                {{ Form::text('name', $lead->subject, ['class' => 'form-control', 'placeholder' => __('Enter Deal Name'), 'required' => 'required']) }}
            </div>
        </div>
        <div class="col-6">
            <div class="form-group">
        ...
        <div class="col-12 exist_client d-none">
            <div class="form-group">
        ...
        <div class="col-6 new_client">
            <div class="form-group">
                ...
                {{ Form::text('client_name', $lead->name, ['class' => 'form-control', 'placeholder' => __('Enter Client Name')]) }}
            </div>
        </div>
        <div class="col-6 new_client">
            <div class="form-group">
                {{ Form::label('client_email', __('Client Email'), ['class' => 'col-form-label']) }}<x-required></x-required>
                {{ Form::text('client_email', $lead->email, ['class' => 'form-control', 'placeholder' => __('Enter Client Email')]) }}
            </div>
        </div>
        <div class="col-6 new_client">
            <div class="form-group">
                {{ Form::label('client_password', __('Client Password'), ['class' => 'col-form-label']) }}<x-required></x-required>
                {{ Form::text('client_password', null, ['class' => 'form-control', 'placeholder' => __('Enter Client Password')]) }}
            </div>
        </div>
        <div class="col-6 new_client">
            <div class="form-group">
                {{ Form::label('company', __('Company'), ['class' => 'col-form-label']) }}
                <select name="company" class="form-control multi-select" data-toggle="select" id="company">
