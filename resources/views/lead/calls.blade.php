...
@if (isset($call))
    {{ Form::model($call, ['route' => ['lead.call.update', $lead->id, $call->id], 'method' => 'post', 'class' => 'needs-validation', 'novalidate']) }}
@else
    {{ Form::open(['route' => ['lead.call.store', $lead->id], 'class' => 'needs-validation', 'novalidate']) }}
@endif
        ...
        @if ($chatgpt_enable)
            <div>
                <a href="#" data-size="md" data-ajax-popup-over="true"
                    data-url="{{ route('generate', ['lead_call']) }}" data-bs-toggle="tooltip" data-bs-placement="top"
