            ...
            <div class="col-md-12 d-flex justify-content-sm-end">
                ...
                @else
                    <div class="text-sm-end d-flex all-button-box justify-content-sm-end">
                        <a href="#" class="btn btn-sm btn-warning mx-1" data-ajax-popup="true" data-size="md"
                            ...
                            data-url="{{ route('lead.convert.deal', $lead->id) }}"
                            title="{{ __('Convert [' . $lead->subject . '] To Deal') }}" data-bs-placement="top"
                ...
                <div class="text-sm-end d-flex all-button-box justify-content-sm-end">
                    <a href="#" class="btn btn-sm btn-dark mx-1" data-ajax-popup="true" data-size="md"
                        data-title="{{ __('Add Label') }}" data-url="{{ route('lead.label', $lead->id) }}"
                        data-bs-original-title="{{ __('Add Label') }}" data-bs-placement="top" data-bs-toggle="tooltip">
                        <i class="ti ti-tag text-white"></i>
                    </a>
                </div>
                <div class="text-sm-end d-flex all-button-box justify-content-sm-end">
                    <a href="#" class="btn btn-sm btn-info mx-1" data-ajax-popup="true" data-size="md"
                        data-title="{{ __('Update Lead') }}" data-url="{{ route('lead.edit', $lead->id) }}"
                        data-bs-original-title="{{ __('Edit') }}" data-bs-placement="top" data-bs-toggle="tooltip">
                ...
                <div class="text-sm-end d-flex all-button-box justify-content-sm-end">
                    <a href="#" class="btn btn-sm btn-danger mx-1 bs-pass-para"
                        ...
                        data-confirm-yes="lead-delete-form-{{ $lead->id }}-{{ $lead->id }}"
                ...
                {!! Form::open([
                    ...
                    'id' => 'lead-delete-form-' . $lead->id . '-' . $lead->id,
                ]) !!}
                {!! Form::close() !!}
            </div>
        </div>
                            ...
                            <div class="card  shadow-none bg-transparent border rounded-0">
                                <div class="card-header">
                                    <div class="row align-items-center justify-content-between">
                                        ...
                                        <div class="col-auto">
                                            @if (\Auth::user()->super_admin_employee == 1)
                                                <a href="#useradd-1" class="btn btn-sm btn-primary mx-1"
                                                        ...
                                                        <div class="col-sm-auto text-sm-end d-flex align-items-center">
                                                            <div class="action-btn">
                                                                <a href="#useradd-1"
                                                                    ...
                                                                    data-confirm="{{ __('Are You Sure?') }}"
                                                                    data-confirm-yes="users-delete-form-{{ $lead->id }}-{{ $user->id }}"
                                                            ...
                                                            {!! Form::open([
                                                                ...
                                                                'id' => 'users-delete-form-' . $lead->id . '-' . $user->id,
                                                            ]) !!}
                                                            {!! Form::close() !!}
                                                        </div>
                                                    @endif
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row align-items-center justify-content-between">
                                ...
                                <div class="col-auto">
                                    @if (\Auth::user()->super_admin_employee == 1)
                                        <a href="#useradd-2" class="btn btn-sm btn-primary mx-1" data-ajax-popup="true"
                                            data-size="md" data-title="{{ __('Add Source') }}"
                                                ...
                                                <div class="col-sm-auto text-sm-end d-flex align-items-center">
                                                    <div class="action-btn">
                                                        <a href="#useradd-2"
                                                            class="mx-3 btn btn-sm btn-danger align-items-center bs-pass-para"
                                                            data-confirm="{{ __('Are You Sure?') }}"
                                                            data-confirm-yes="sources-delete-form-{{ $lead->id }}-{{ $source->id }}"
                                                            title="{{ __('Delete') }}" data-bs-toggle="tooltip"
                                                            data-bs-placement="top">
                                                            <i class="ti ti-trash"></i>
                                                        </a>
                                                    ...
                                                    {!! Form::open([
                                                        ...
                                                        'id' => 'sources-delete-form-' . $lead->id . '-' . $source->id,
                                                    ]) !!}
                                                    {!! Form::close() !!}
                                                        ...
                                                        <div class="col-auto actions">
                                                            <div class="action-btn">
                                                                <a href="#useradd-3"
                                                                    class="mx-3 btn btn-sm btn-danger align-items-center bs-pass-para"
                                                                    data-confirm="{{ __('Are You Sure?') }}"
                                                                    data-confirm-yes="file-delete-form-{{ $lead->id }}-{{ $file->id }}"
                                                                    title="{{ __('Delete') }}" data-bs-toggle="tooltip"
                                                                    data-bs-placement="top">
                                                                    <i class="ti ti-trash"></i>
                                                                </a>
                                                            ...
                                                            {!! Form::open([
                                                                ...
                                                                'id' => 'file-delete-form-' . $lead->id . '-' . $file->id,
                                                            ]) !!}
                                                            {!! Form::close() !!}
                                                        </div>
                                                    </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row align-items-center justify-content-between">
                                ...
                                <div class="col-auto">
                                    <a href="#useradd-4" class="btn btn-sm btn-primary mx-1" data-ajax-popup="true"
                                        data-size="md" data-title="{{ __('Add Discussion') }}"
                        ...
                        <div class="card-body">
                            <ul class="list-group list-group-flush">
                                @foreach ($lead->discussions as $discussion)
                                    <a href="#useradd-4" class="list-group-item bg-transparent border rounded-0 mb-3">
                                        <div class="d-flex align-items-center">
                                            <div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row align-items-center justify-content-between">
                                ...
                                <div class="col-auto">
                                    @if (\Auth::user()->super_admin_employee == 1)
                                        <a href="#useradd-5" class="btn btn-sm btn-primary mx-1" data-ajax-popup="true"
                                            data-size="md" data-title="{{ __('Create Call') }}"
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <div class="action-btn me-2">
                                                        <a href="#useradd-5"
                                                            class="mx-3 btn btn-sm btn-danger align-items-center bs-pass-para"
                                                            data-confirm="{{ __('Are You Sure?') }}"
                                                            data-confirm-yes="call-delete-form-{{ $lead->id }}-{{ $call->id }}"
                                                            title="{{ __('Delete') }}" data-bs-toggle="tooltip"
                                                            data-bs-placement="top">
                                                            <i class="ti ti-trash"></i>
                                                        </a>
                                                    ...
                                                    {!! Form::open([
                                                        ...
                                                        'id' => 'call-delete-form-' . $lead->id . '-' . $call->id,
                                                    ]) !!}
                                                    {!! Form::close() !!}
                                                </td>
                                            @endif
                        ...
                        <div class="card-header">
                            <div class="row align-items-center justify-content-between">
                                ...
                                <div class="col-auto">
                                    @if (\Auth::user()->super_admin_employee == 1)
                                        <a href="#useradd-5" class="btn btn-sm btn-primary mx-1" data-ajax-popup="true"
                                            data-size="md" data-title="{{ __('Create Email') }}"
                        ...
                        <div class="card-body">
                            <ul class="list-group list-group-flush">
                                @foreach ($emails as $email)
                                    <a href="#useradd-5" class="list-group-item bg-transparent border-bottom rounded-0 mb-3">
                                        <div class="d-flex align-items-center">
                                            <div>
