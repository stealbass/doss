@if ($customFields)
    @foreach ($customFields as $customField)
        @if ($customField->id == '1')
            <div class="col-lg-6">
                <div class="form-group mb-3 {{ $customField->width }}">
                    <label for="name" class="form-label">{{ __($customField->name) }}</label><x-required></x-required>
        ...
        @elseif($customField->id == '2')
            <div class="col-lg-6">
                <div class="form-group mb-3 {{ $customField->width }}">
                    <label for="email" class="form-label">{{ __($customField->name) }}</label><x-required></x-required>
                    <div class="form-icon-user">
        ...
        @elseif($customField->id == '3')
            <div class="col-lg-6">
                <div class="form-group mb-3 {{ $customField->width }}">
                    <label for="category" class="form-label">{{ __($customField->name) }}</label><x-required></x-required>
                    <select class="form-select" id="category" name="category"
                        data-placeholder="{{ __($customField->placeholder) }}" required>
        ...
        @elseif($customField->id == '4')
            <div class="col-lg-6">
                <div class="form-group mb-3 {{ $customField->width }}">
                    <label for="subject" class="form-label">{{ __($customField->name) }}</label><x-required></x-required>
                    <div class="form-icon-user">
        ...
        @elseif($customField->id == '6')
            <div class="col-lg-6">
                <div class="form-group mb-3 {{ $customField->width }}">
                    <label for="company" class="form-label">{{ __($customField->name) }}</label><x-required></x-required>
        ...
        @elseif($customField->id == '7')
            <div class="col-lg-6">
                <div class="form-group mb-3 {{ $customField->width }}">
                    <label for="priority" class="form-label">{{ __($customField->name) }}</label><x-required></x-required>
