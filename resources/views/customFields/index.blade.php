...
@section('page-title', __('Manage Ticket Fields'))
...
@section('breadcrumb')
    <li class="breadcrumb-item">{{ __('Manage Ticket Fields') }}</li>
@endsection
                        ...
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <div class="">
                                ...
                                <label class="form-check-label pe-5 text-muted"
                                    for="enable_chat">{{ __('You can easily change order of fields using drag & drop.') }}
                                </label>
                            </div>
                                            ...
                                            <tr data-repeater-item>
                                                ...
                                                <td>
                                                    <input type="text" name="placeholder" class="form-control mb-0"
                                                        required placeholder="{{__('Enter Placeholder')}}" />
                                                </td>
                                                <td>
                                                ...
                                                <td class="text-center">
                                                    <a data-repeater-delete class="btn btn-danger btn-sm delete-icon">
