...
@section('action-button')
    <div class="row justify-content-end">
        <div class="col-auto">
            <a href="{{ route('tickets.export') }}" class="btn btn-sm btn-primary" data-bs-toggle="tooltip"
                data-bs-placement="top" title="{{ __('Export') }}"><i class="ti ti-file-export text-white"></i></a>
            <a href="{{ route('tickets.create') }}" class="btn btn-sm btn-primary mx-1" data-bs-toggle="tooltip"
                            ...
                            <tbody>
                                @foreach ($tickets as $ticket)
                                    <tr>
                                        ...
                                        <td><span
                                                class="badge p-2 px-3 fix_badge
