...
@section('page-title', __('Comapny Detail'))
...
@section('breadcrumb')
    <li class="breadcrumb-item">{{ __('Comapny Detail') }}</li>
@endsection
                    ...
                    <div id="useradd-2" class="card  shadow-none rounded-0 border-bottom">
                        ...
                        <div class="card-body">
                            <div class=" setting-card">
                                <div class="row">
                                    <div
                                        class="col-xxl-3 col-lg-5 col-md-6 col-sm-6 plan_card mb-0 border-bottom border-end">
