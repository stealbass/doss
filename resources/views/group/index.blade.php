    ...
    @can('create group')
        <div class="text-sm-end d-flex all-button-box justify-content-sm-end">
            <a href="#" class="btn btn-sm btn-primary mx-1" data-ajax-popup="true" data-size="md"
                data-title="{{ __('Create Group') }}" data-url="{{ route('groups.create') }}"
                            ...
                            <tbody>
                                @foreach ($groups as $key => $group)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{ date('j F, Y', strtotime($group->created_at)) }}
                                            ...
                                            @can('show group')
                                                <div class="action-btn me-2">
                                                    <a href="#" class="mx-3 btn btn-sm btn-warning align-items-center "
                                                        ...
                                                        data-ajax-popup="true"
                                                        data-title="{{ $group->name }}{{ __("'s Group Members") }}"
                                                        title="{{ __('View Member') }}" data-bs-toggle="tooltip"
                                                        data-bs-placement="top">
                                                        <i class="ti ti-eye "></i>
                                                    </a>
                                                </div>
                                            ...
                                            @can('edit group')
                                                <div class="action-btn me-2">
                                                    <a href="#" class="mx-3 btn btn-sm btn-info align-items-center "
                                                        ...
                                                        data-ajax-popup="true" data-title="{{ __('Update Group') }}"
