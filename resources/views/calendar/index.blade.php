    ...
    @can('manage diary')
        <div class="text-sm-end d-flex all-button-box justify-content-sm-end">
            <a href="{{ route('casediary.index') }}" class="btn btn-sm btn-primary mx-1" data-bs-toggle="tooltip"
                data-bs-placement="top" data-bs-original-title="{{ __('Diary View') }}">
                ...
                <div class="card-body px-0">
                    ...
                    <ul class="event-cards list-group list-group-flush w-100">
                        @foreach ($events as $calenderData)
                            ...
                            @if ($month == date('m'))
                                <li
                                    class="list-group-item card bg-transparent border-top border-bottom rounded-0 shadow-none mb-3">
                                        ...
                                        <div class="col-auto mb-3 mb-sm-0">
                                            <div class="d-flex align-items-center">
                                                <div
                                                    ...
                                                    <i
                                                        class="{{ $calenderData['data_name'] == 'hearing' ? 'ti ti-file-text' : 'ti ti-file-plus' }}"></i>
                                                </div>
                                                <div class="ms-3">
                                                    <h6 class="m-0">
