...
class _LegalMonitoringScreenState extends State<LegalMonitoringScreen>
  ...
  final List<Map<String, dynamic>> _newsItems = [
    {
      ...
      'summary':
          'Le gouvernement ivoirien a adopté une série d\'amendements au Code du Travail visant à améliorer les conditions de travail et renforcer la protection des travailleurs.',
      'isNew': true,
    },
    {
      ...
      'summary':
          'La Cour Suprême précise les conditions d\'application de la prescription acquisitive trentenaire dans un arrêt de principe.',
      'isNew': true,
    },
    {
      ...
      'jurisdiction': 'Côte d\'Ivoire',
      'summary':
          'La Loi de Finances 2024 introduit plusieurs mesures fiscales importantes pour les entreprises et les particuliers.',
      'isNew': false,
    },
    {
      ...
      'summary':
          'Nouvelle directive de la CEDEAO établissant un cadre juridique harmonisé pour le commerce électronique en Afrique de l\'Ouest.',
      'isNew': false,
    },
  ];
  ...
  Widget build(BuildContext context) {
    ...
    // Legal Monitoring available for Pro and Cabinet
  ...
  Widget _buildNewsTab(
      BuildContext context, bool isFr, ColorScheme colorScheme) {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              children: [
                const Icon(Icons.newspaper, size: 40, color: Colors.white),
          ...
          Wrap(
            ...
            children: [
              FilterChip(
                ...
                selected: true,
                onSelected: (value) {},
                selectedColor: AppConstants.primaryGreen.withValues(alpha: 0.3),
              ),
              FilterChip(
        ...
        children: [
          ...
          Wrap(
            ...
            children: AppConstants.countries.map((country) {
              final isSelected =
                  _selectedJurisdictions.contains(country['name']);
              return FilterChip(
                label: Text('${country['flag']} ${country['name']}'),
                selected: isSelected,
                onSelected: (value) =>
                    _toggleJurisdiction(country['name'] as String),
                selectedColor: AppConstants.primaryGreen.withValues(alpha: 0.3),
                checkmarkColor: AppConstants.primaryGreen,
              );
            }).toList(),
          ...
          SwitchListTile(
            ...
            subtitle: Text(isFr
                ? 'Résumé quotidien des actualités'
                : 'Daily news summary'),
            value: true,
            activeThumbColor: AppConstants.primaryGreen,
            onChanged: (value) {},
          ...
          SwitchListTile(
            title: Text(
                isFr ? 'Alertes urgentes uniquement' : 'Urgent alerts only'),
            subtitle: Text(isFr
                ? 'Uniquement les changements majeurs'
                : 'Only major changes'),
            value: false,
            activeThumbColor: AppConstants.primaryGreen,
            onChanged: (value) {},
