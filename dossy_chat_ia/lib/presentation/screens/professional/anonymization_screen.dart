...
class _AnonymizationScreenState extends State<AnonymizationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Anonymization is available from Professional plan and above
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(12),
                        border: Border.all(
                          color: AppConstants.primaryGreen.withAlpha((0.3 * 255).round()),
                          width: 2,
                    ...
                    return Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          IconButton(
                            icon: const Icon(Icons.download, color: AppConstants.primaryGreen),
                            onPressed: () {
                              ScaffoldMessenger.of(context).showSnackBar(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 24),
            Text(
              isFr ? 'Fonctionnalité Professionnel+' : 'Professional+ Feature',
              style: const TextStyle(fontSize: 24, fontWeight: FontWeight.bold),
            ),
            const SizedBox(height: 12),
            Text(
              isFr
                  ? 'L\'anonymisation de documents est disponible à partir du plan Professionnel.'
                  : 'Document anonymization is available from Professional plan and above.',
