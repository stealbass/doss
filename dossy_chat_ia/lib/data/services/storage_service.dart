...
class StorageService {
  ...
  /// Save anonymization enabled state
  Future<void> saveAnonymizationEnabled(bool enabled) async {
    await _prefs.setBool(_keyAnonymizationEnabled, enabled);
  }

  /// Check if anonymization is enabled
  /// Returns true by default for users who have access to anonymization
  bool isAnonymizationEnabled() {
    // If the key doesn't exist, return true (enabled by default)
    return _prefs.getBool(_keyAnonymizationEnabled) ?? true;
  }
