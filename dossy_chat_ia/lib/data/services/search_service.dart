...
class SearchService {
  ...
  Future<Map<String, dynamic>> searchDocuments({
    ...
    try {
      ...
      final uri = Uri.parse('$baseUrl/mobile/documents/search');

      print('DEBUG: Legal library search URL: $uri');
      ...
      print('DEBUG: Legal library response: ${response.statusCode}, body: ${response.body.substring(0, response.body.length > 200 ? 200 : response.body.length)}');
      ...
      print('DEBUG: Legal library search error: $e');
      return {
        'success': false,
