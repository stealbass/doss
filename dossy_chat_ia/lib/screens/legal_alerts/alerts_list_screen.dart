...
import '../../providers/legal_alert_provider.dart';import '../../l10n/app_localizations.dart';import '../../providers/auth_provider.dart';
...
class _AlertsListScreenState extends State<AlertsListScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(l10n.legalAlertsTitle),
        elevation: 0,
        actions: [
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    FilterChip(
                      label: Text('${l10n.unread} (${provider.unreadCount})'),
