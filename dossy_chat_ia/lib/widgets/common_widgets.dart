  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: _getPlanColor(planName).withAlpha((0.1 * 255).round()),
          ...
          child: Row(
            ...
            children: [
              ...
              Container(
                ...
                height: 48,
                decoration: BoxDecoration(
                  color: _getFileColor(fileType).withAlpha((0.1 * 255).round()),
                    ...
                    Row(
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: _getPriorityColor(priority).withAlpha((0.1 * 255).round()),
                            borderRadius: BorderRadius.circular(4),
                          ),
                          child: Text(
