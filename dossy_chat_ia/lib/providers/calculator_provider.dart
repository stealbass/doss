...
class CalculatorProvider with ChangeNotifier {
  ...
  final Map<String, CalculationResult?> _results = {};
  ...
  Future<void> fetchCalculators(String token) async {
    ...
    try {
      final response = await http.get(
        Uri.parse('${ApiConstants.baseUrl}/calculators'),
        headers: {
  ...
  Future<Map<String, dynamic>?> calculate(
    ...
    try {
      final response = await http.post(
        Uri.parse('${ApiConstants.baseUrl}/calculators/$calculatorId/calculate'),
        headers: {
          'Authorization': 'Bearer $token',
          'Accept': 'application/json',
