...
@push('css-page')
    <link rel="stylesheet" href=" {{ asset('public/LandingPage_assets/css/summernote/summernote-bs4.css') }}" />
@endpush

@push('script-page')
    <script src="{{ asset('public/LandingPage_assets/js/plugins/summernote-bs4.js') }}" referrerpolicy="origin">
    </script>
@endpush
            ...
            <div class="col-xl-9">
                <div class="card rounded-0 shadow-none bg-transparent">
                    ...
                    <div class="card-footer text-end border-bottom rounded-0">
                        <button class="btn btn-print-invoice btn-primary m-r-10" type="submit">{{ __('Save Changes') }}
                        </button>
                    </div>
                    {{ Form::close() }}
                </div>
                                                    ...
                                                    <span>
                                                        <div class="action-btn me-2">
                                                            <a href="#" class="mx-3 btn btn-sm btn-info align-items-center"
                                                                ...
                                                                data-ajax-popup="true" data-title="{{ __('Update FAQ') }}"
                                                                title="{{ __('Edit') }}" data-size="lg"
