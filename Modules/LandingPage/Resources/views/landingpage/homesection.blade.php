                                ...
                                <div class="form-group">
                                    ...
                                    <div class="d-flex justify-content-sm-end">
                                        <button class="btn btn-sm btn-primary btn-icon m-1 " data-repeater-create
                                            type="button" data-bs-toggle="tooltip" title="{{ __('Create') }}"><i
                                                class="ti ti-plus"></i>
                                        </button>
                                    </div>
                                                    ...
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-auto">
                                                            <p class="card-text small text-muted">
                                                                <img src="{{ $logo . '/home_logo.png' }}" width="70px"
                                                                    id="home_logo" alt="Image placeholder"
                                                                    data-dz-thumbnail="">
                                                            </p>
                                                        </div>
                                                        <div class="col-auto actions">
                                                            <a data-repeater-delete href="javascript:void(0)"
                                                                ...
                                                                class="action-item btn btn-sm btn-icon btn-danger ms-2 delete-button">
                                            ...
                                            <div class="card mb-3 border shadow-none product_Image">
                                                <div class="px-2 py-2">
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-auto actions">
                                                            <a class="action-item btn btn-sm btn-icon btn-warning"
