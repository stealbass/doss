@php
    ...
    \App::setLocale(isset($setting['default_language']) ? $setting['default_language'] : 'en');
@endphp
...
<head>
    <title>
        Logiciel de Gestion pour Cabinet Juridique en Afrique | Dossy Pro
    </title>
    <!-- Meta -->
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=0, minimal-ui" />

    <meta name="title" content="Logiciel de Gestion pour Cabinet Juridique en Afrique | Dossy Pro">
    <meta name="description" content="Dossy Pro, le logiciel de gestion et bibliothèque tout-en-un pour cabinet juridique en Afrique. Gérez facilement vos dossiers, facturation, clients et équipe. Adapté aux avocats, notaires et huissiers.">
    <meta name="base-url" content="{{ URL::to('/') }}">

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="{{ env('APP_URL') }}">
    <meta property="og:title" content="Logiciel de Gestion pour Cabinet Juridique en Afrique | Dossy Pro">
    <meta property="og:description" content="Dossy Pro, le logiciel de gestion et bibliothèque juridique tout-en-un pour cabinet juridique en Afrique. Gérez facilement vos dossiers, facturation, clients et équipe. Adapté aux avocats, notaires et huissiers.">
    <meta property="og:image" content="{{ $meta_image . $meta_logo }}">

    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="{{ env('APP_URL') }}">
    <meta property="twitter:title" content="Logiciel de Gestion pour Cabinet Juridique en Afrique | Dossy Pro">
    <meta property="twitter:description" content="Dossy Pro, le logiciel de gestion et bibliothèque tout-en-un pour cabinet juridique en Afrique. Gérez facilement vos dossiers, facturation, clients et équipe. Adapté aux avocats, notaires et huissiers.">
    ...
    <!-- Méta pour géociblage Afrique francophone -->
    <meta name="geo.region" content="FR-AF">
    <meta name="geo.position" content="14.4974;-14.4524">
    <meta name="geo.placename" content="Afrique Francophone">

    <!-- Meta keywords (utilisé modérément) -->
    <meta name="keywords" content="logiciel juridique, gestion cabinet avocat, logiciel avocat afrique, gestion cabinet juridique, solution juridique en ligne, Bibliothèque de modèles juridiques">
    <!-- Favicon icon -->
    <link rel="icon"
    ...
    @else
        <link rel="stylesheet" href="{{ asset('public/LandingPage_assets/css/style.css') }}" id="main-style-link">
    @endif
    ...
    <link rel="canonical" href="https://dossypro.com/">
    ...
    <!-- Schema.org spécifique secteur juridique -->
    <script type="application/ld+json">
    {
        "@context": "https://schema.org",
        "@type": "SoftwareApplication",
        "name": "Dossy Pro",
        "description": "Solution complète de gestion pour cabinets juridiques en Afrique",
        ...
        "audience": {
            ...
            "audienceType": "Avocats, Huissiers, Notaires, Cabinets juridiques, Juristes"
        },
        "featureList": [
            "Gestion et numérisation des dossiers juridiques",
            "Facturation conforme",
            "Bibliothèque de modèles juridiques",
            "Conformité RGPD",
            "Agenda et suivi des tâches",
        ],
        "aggregateRating": {
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-8SF0TQ4PWZ"></script>
    <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'G-8SF0TQ4PWZ');
    </script>
    ...
    })(window, document, "clarity", "script", "stm60nayly");
</script>

<script src="https://analytics.ahrefs.com/analytics.js" data-key="yFwZUDGlz70ZlTHn1NUzug" async></script>
    ...
    <section class="main-banner bg-primary" id="home">
                    ...
                    <div class="d-flex gap-3 mt-4 banner-btn">
                        ...
                        @if ($settings['home_buy_now_link'])
                            <a href="{{ $settings['home_buy_now_link'] }}" class="btn btn-outline-dark">
                                {{ __('Buy Now') }} <i data-feather="lock" class="ms-2"></i>
                            </a>
                        @endif
                    </div>
                </div>
                <div class="col-xxl-8 col-md-6">
                    ...
                    <div>
                        <img class="img-fluid preview-img" src="{{ $logo . '/' . $settings['home_banner'] }}"
                            alt="Solution Complète pour Avocats et Juristes">
                    </div>
                    {{-- @endif --}}
                </div>
            </div>
        ...
        <div class="container">
            <div class="row g-0 gy-2 mt-4 align-items-center">
                <div class="col-xxl-3">
                    <p class="mb-0">{{ __('Trusted by') }}
                        <b class="fw-bold">
                            {{ $settings['home_trusted_by'] }}
                        </b>
                    </p>
                </div>
                <div class="col-xxl-9">
                    <div class="row gy-3 row-cols-9">
                        @foreach (explode(',', $settings['home_logo']) as $k => $home_logo)
                            <div class="col-auto">
                                ...
                                <img src="{{ $logo . '/' . $home_logo }}" alt="Solution Complète pour Avocats et Juristes" class="landing_logo"
                                    style="width: 130px;">
                                {{-- @endif --}}
                            </div>
                        @endforeach
                                    ...
                                    <div class="card {{ $key == 0 ? 'bg-primary' : '' }}">
                                        <div class="card-body">
                                            <span class="theme-avtar avtar avtar-xl mb-4">
                                                <img src="{{ $logo . '/' . $value['feature_logo'] }}" alt="Solution Complète pour Avocats et Juristes">
                                            </span>
                ...
                <div class="mt-5">
                    ...
                    <div class="features-preview">
                        <img class="img-fluid m-auto d-block"
                            src="{{ $logo . '/' . $settings['highlight_feature_image'] }}" alt="Solution Complète pour Avocats et Juristes">
                    </div>
                    {{-- @endif --}}
                </div>
            </div>
                        ...
                        <div class="row align-items-center justify-content-center mb-4">
                            <div class="col-lg-4 col-md-6">
                                ...
                                <a href="{{ $value['other_feature_buy_now_link'] }}"
                                    class="btn btn-primary rounded-pill d-inline-flex align-items-center">
                                    {{ __('Live Demo') }}
                                    <i data-feather="lock" class="ms-2"></i>
                                </a>
                            </div>
                            <div class="col-lg-7 col-md-6 res-img">
                                {{-- @if (Storage::exists('/uploads/landing_page_image/' . $value['other_features_image'])) --}}
                                <div class="img-wrapper">
                                    <img src="{{ $logo . '/' . $value['other_features_image'] }}" alt="Solution Complète pour Avocats et Juristes"
                    ...
                    @else
                        <div class="row align-items-center justify-content-center mb-4">
                            ...
                            <div class="col-lg-4  col-md-6">
                                ...
                                <a href="{{ $value['other_feature_buy_now_link'] }}"
                                    class="btn btn-primary rounded-pill d-inline-flex align-items-center">
                                    {{ __('Live Demo') }} <i data-feather="lock" class="ms-2"></i>
                                </a>
                            </div>
                        </div>
                    @endif
        ...
        <div class="container">
                            ...
                            <div class="card   border {{ $key == 1 ? 'bg-primary' : 'bg-transparent' }}">
                                <div class="card-body text-center">
                                    <span class="theme-avtar avtar avtar-xl mx-auto mb-4">
                                        <img src="{{ $logo . '/' . $value['discover_logo'] }}" alt="Solution Complète pour Avocats et Juristes">
                                    </span>
            ...
            <div class="d-flex flex-column justify-content-center flex-sm-row gap-3 mt-3">
                ...
                @if ($settings['discover_buy_now_link'])
                    <a href="{{ $settings['discover_buy_now_link'] }}" class="btn btn-primary rounded-pill">
                        {{ __('Buy Now ') }} <i data-feather="lock" class="ms-2"></i>
                    </a>
                @endif
            </div>
                            ...
                            <div class="screenshot-card">
                                ...
                                <div class="img-wrapper">
                                    <img src="{{ $logo . '/' . $value['screenshots'] }}"
                                        class="img-fluid header-img mb-4 shadow-sm" alt="Solution Complète pour Avocats et Juristes">
                                </div>
                                {{-- @endif --}}
    ...
    <section class="subscription bg-primary section-gap" id="plan">
        <div class="container">
            ...
            <div class="row justify-content-center">
                @php
                    $collection = \App\Models\Plan::where('status', 1)->orderBy('price', 'ASC')->take(3)->get();
                    ...
                    <div class="col-xxl-3 col-lg-4 col-md-6">
                        <div class="card price-card shadow-none {{ $key == 2 ? 'bg-dark' : '' }}">
                            <div class="card-body">
                                ...
                                <span
                                    class="mb-4 f-w-00 p-price">{{ number_format($value->price, 0, '', ' ') }} {{ isset($admin_payment_setting['currency_symbol']) ? $admin_payment_setting['currency_symbol'] : '$' }}<small
                                ...
                                <div class="d-grid">
                                    <a href="{{ route('payment', \Illuminate\Support\Facades\Crypt::encrypt($value->id)) }}"
                                        ...
                                        {{ __('Start with') }} {{$value->name}} <i data-feather="log-in" class="ms-2"></i>
                                    </a>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="card-body p-3">
                                            ...
                                            <div class="d-flex  align-items-center ">
                                                <img src="{{ $logo . '/' . $value->testimonials_user_avtar }}"
                                                    class="wid-40 rounded-circle me-3" alt="Solution Complète pour Avocats et Juristes">
                                                <span>
